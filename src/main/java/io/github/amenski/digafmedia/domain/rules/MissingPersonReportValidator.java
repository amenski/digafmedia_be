...
public final class MissingPersonReportValidator {

    private MissingPersonReportValidator() {
        // Utility class - prevent instantiation
    }

    public static ValidationResult validateCreateCommand(CreateMissingPersonReportCommand command) {
        ValidationResult result = new ValidationResult();
        
        if (command == null) {
            result.addError("command", "Missing person report command cannot be null");
            return result;
        }
